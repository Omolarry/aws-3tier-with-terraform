...
resource "aws_eip" "eip1" {
  ...
  tags = {
    Name = "${var.my_project_name}-${var.environment}-eip1"
  }
}
...
resource "aws_eip" "eip2" {
  ...
  tags = {
    Name = "${var.my_project_name}-${var.environment}-eip2"
  }
}
...
resource "aws_nat_gateway" "nat_gateway_az1" {
  ...
  tags = {
    Name = "${var.my_project_name}-${var.environment}-ng-az1"
  }
...
resource "aws_nat_gateway" "nat_gateway_az2" {
  ...
  tags = {
    Name = "${var.my_project_name}-${var.environment}-ng-az2"
  }
...
resource "aws_route_table" "private_route_table_az1" {
  ...
  tags = {
    Name = "${var.my_project_name}-${var.environment}-private-rt-az1"
  }
}
...
resource "aws_route_table" "private_route_table_az2" {
  ...
  tags = {
    Name = "${var.my_project_name}-${var.environment}-private-rt-az2"
  }
}
